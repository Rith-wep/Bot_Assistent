...
export default function AIProfileSection({ profile, rules, onProfileSaved, onRulesSaved, showToast }) {
  ...
  return <SectionCard title="AI profile and business rules" description="Shape how your assistant speaks and what it must always remember.">
    ...
    <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
      ...
      <div><label className="mb-1 block text-sm font-medium text-ink">Language mode</label><select className={fieldClass} value={form.language_mode} onChange={(e) => update("language_mode", e.target.value)}><option value="mirror">Mirror customer language</option><option value="khmer_default">Khmer by default</option><option value="english">English</option></select></div>
    </div>
